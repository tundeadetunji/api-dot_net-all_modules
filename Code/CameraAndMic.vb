...
#Region "Initialization"
    ...
    ''' For optimum results, prefer playback/viewing from folder path (or directory__) - not from List(Of Images) or ImagesCaptured or ImageCaptured.
    ''' </summary>
...
#Region "Callback"
    ...
    Private Sub SendImageToWeb(directory_ As String, ftp_server As String, username As String, password As String, remoteFolderPathEscapedString As String, Optional target_filename_without_extension As String = "01")
        ...
        If possible_image IsNot Nothing Then
            ...
            serverside.uploadBytes(target_filename_without_extension & ext__, PictureFromStream(possible_image), remoteFolderPathEscapedString)
        End If

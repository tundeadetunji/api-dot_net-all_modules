...
#Region "Map"
    Public Shared ReadOnly Property FileKindExtensionsMap As Dictionary(Of FileKind, List(Of String))
        Get
            Dim map As New Dictionary(Of FileKind, List(Of String))
            With map
                .Add(FileKind.ActiveServerPageFileKind, GetEnum(New ActiveServerPageFileKind))
                .Add(FileKind.AudioFileKind, GetEnum(New AudioFileKind))
                .Add(FileKind.BatchFileKind, GetEnum(New BatchFileKind))
                .Add(FileKind.CSharpFileKind, GetEnum(New CSharpFileKind))
                .Add(FileKind.ExcelSpreadsheetFileKind, GetEnum(New ExcelSpreadsheetFileKind))
                .Add(FileKind.ExecutableFileKind, GetEnum(New ExecutableFileKind))
                .Add(FileKind.JavaFileKind, GetEnum(New JavaFileKind))
                .Add(FileKind.JavaScriptFileKind, GetEnum(New JavaScriptFileKind))
                .Add(FileKind.JSONFileKind, GetEnum(New JSONFileKind))
                .Add(FileKind.MarkdownFileKind, GetEnum(New MarkdownFileKind))
                .Add(FileKind.NotepadFileKind, GetEnum(New NotepadFileKind))
                .Add(FileKind.PDFFileKind, GetEnum(New PDFFileKind))
                .Add(FileKind.PictureFileKind, GetEnum(New PictureFileKind))
                .Add(FileKind.POMFileKind, GetEnum(New POMFileKind))
                .Add(FileKind.PowerPointFileKind, GetEnum(New PowerPointFileKind))
                .Add(FileKind.PythonFileKind, GetEnum(New PythonFileKind))
                .Add(FileKind.ShortcutFileKind, GetEnum(New ShortcutFileKind))
                .Add(FileKind.SQLFileKind, GetEnum(New SQLFileKind))
                '.Add(FileKind.DirectoryFileKind, New List(Of String))
                .Add(FileKind.VisualBasicFileKind, GetEnum(New VisualBasicFileKind))
                .Add(FileKind.VideoFileKind, GetEnum(New VideoFileKind))
                .Add(FileKind.VisualStudioFileKind, GetEnum(New VisualStudioFileKind))
                .Add(FileKind.WebPageFileKind, GetEnum(New WebPageFileKind))
                .Add(FileKind.WindowsBuildFileKind, GetEnum(New WindowsBuildFileKind))
                .Add(FileKind.WindowsMediaPlayerPlaylistFileKind, GetEnum(New WindowsMediaPlayerPlaylistFileKind))
                .Add(FileKind.WordDocumentFileKind, GetEnum(New WordDocumentFileKind))
                .Add(FileKind.XMLFileKind, GetEnum(New XMLFileKind))
            End With
            Return map
        End Get
    End Property
...
#Region "proper"
    ...
    Public Enum FileKind
        ...
        BatchFileKind = 2
        CSharpFileKind = 3
        ExcelSpreadsheetFileKind = 4
        ExecutableFileKind = 5
        JavaFileKind = 6
        JavaScriptFileKind = 7
        JSONFileKind = 8
        MarkdownFileKind = 9
        NotepadFileKind = 10
        PDFFileKind = 11
        PictureFileKind = 12
        PowerPointFileKind = 13
        PythonFileKind = 14
        ShortcutFileKind = 15
        SQLFileKind = 16
        'DirectoryFileKind = 17
        VisualBasicFileKind = 17
        VideoFileKind = 18
        VisualStudioFileKind = 19
        WebPageFileKind = 20
        WindowsBuildFileKind = 21
        WindowsMediaPlayerPlaylistFileKind = 22
        WordDocumentFileKind = 23
        XMLFileKind = 24
        POMFileKind = 25
        AnyFileKind = 26
    End Enum
    Public Enum ActiveServerPageFileKind
        aspx = 0
        asp = 1
    End Enum
    Public Enum WebPageFileKind
        htm = 0
        html = 1
        xhtml = 2
        mht = 3
    End Enum
    Public Enum WordDocumentFileKind
        doc = 0
        docx = 1
    End Enum
    Public Enum WindowsBuildFileKind
        msi = 0
    End Enum
    ...
    Public Enum WindowsMediaPlayerPlaylistFileKind
        wpl = 0
    End Enum
    Public Enum XMLFileKind
        xml = 0
    End Enum
    Public Enum VisualStudioFileKind
        sln = 0
    End Enum
    Public Enum VisualBasicFileKind
        vb = 0
    End Enum
    Public Enum VideoFileKind
        mp4 = 0
        _3gp = 1
        _3gpp = 2
        _3gp2 = 3
        ...
        webm = 15
    End Enum
    Public Enum ShortcutFileKind
        lnk = 0
    End Enum
    Public Enum SQLFileKind
        sql = 0
    End Enum
    Public Enum PythonFileKind
        py = 0
    End Enum
    Public Enum BatchFileKind
        bat = 0
    End Enum
    Public Enum CSharpFileKind
        cs = 0
    End Enum
    Public Enum PDFFileKind
        pdf = 0
    End Enum
    Public Enum PowerPointFileKind
        ppt = 0
        pptx = 1
        ppsx = 2
        pps = 3
    End Enum
    Public Enum PictureFileKind
        gif = 0
        jpg = 1
        jpeg = 2
        tif = 3
        ...
        ico = 6
    End Enum
    Public Enum NotepadFileKind
        txt = 0
    End Enum
    Public Enum ExecutableFileKind
        exe = 0
    End Enum
    Public Enum JavaFileKind
        java = 0
    End Enum
    Public Enum JSONFileKind
        json = 0
    End Enum
    Public Enum JavaScriptFileKind
        js = 0
    End Enum
    Public Enum MarkdownFileKind
        md = 0
    End Enum
    Public Enum ExcelSpreadsheetFileKind
        xls = 0
        xlsx = 1
    End Enum
...
#Region "support"
    ...
    Public Shared Function ExtensionsFromFileKind(fileKind As FileKind) As List(Of String)
        ...
        If fileKind = FileKind.AnyFileKind Then
            ...
            Return result
        End If
        Dim types As List(Of String) = FileKindExtensionsMap.Item(fileKind)
...
#Region "Support Functions"
    ...
    Public Shared Function EnumFromString(EnumInstance As Object, Key As String)
        ...
        Dim values As List(Of String) = GetEnum(EnumInstance, True)
        For i = 0 To keys.Count - 1
            dict.Add(keys(i), Integer.Parse(values(i)))
        Next
